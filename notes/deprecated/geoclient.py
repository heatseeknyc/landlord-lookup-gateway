#
# A simple Flask service, designed to be interface-compatible with
# the NYC's Geoclient API, but constrained to provide a much smaller 
# JSON payload (restricted to fields of interest) -- and running off
# of our own dataset.
#
...
#
# A minimalst endpoint handler which simply calls the internal API,
